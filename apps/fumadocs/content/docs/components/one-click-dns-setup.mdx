...
description: Send customers from your SaaS domain settings page to a supported DNS provider for reviewed, automatic record configuration.
---
...
| bunny.net            | Bunny DNS             | Manual records                                              |
