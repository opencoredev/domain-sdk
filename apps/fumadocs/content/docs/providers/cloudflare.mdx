---
title: Cloudflare for SaaS custom domains
description: Manage Cloudflare for SaaS Custom Hostnames with a server-side TypeScript adapter for normalized status, DNS records, and certificates.
icon: cloudflare
---
