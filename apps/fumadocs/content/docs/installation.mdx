---
title: Install Domain SDK for TypeScript
description: Install the server-side TypeScript SDK and start managing SaaS customer domains with Vercel, Cloudflare, Railway, Render, Netlify, or bunny.net.
---
...
<Cards>
  ...
  <Card
    title="bunny.net"
    description="Custom hostnames on one CDN pull zone"
    href="/docs/providers/bunny"
  />
</Cards>
...
<Tabs items={["Vercel", "Cloudflare", "Railway", "Render", "Netlify", "bunny.net"]}>
  <Tab value="Vercel">
